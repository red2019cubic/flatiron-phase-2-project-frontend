    ...
    <div className="addplayer">
      ...
      <div className="form">
        <form className="formdata" onSubmit={handleSubmit}>
          ...
          <br />
          <br />
          <input type="text" name="pts" placeholder="Player PTS" value={PTS}
            onChange={(e) => setPTS(e.target.value)}/>
          <input type="text" name="team" placeholder="Player Team" value={team}
          onChange={(e) => setTeam(e.target.value)}/>
          <br />
          <br />
          <input type="text" name="season" placeholder="Player Season" value={season}
